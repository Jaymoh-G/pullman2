...
class COPSinglePage extends Component
{
    public $slug;
    public $user_name;
    public $email;
    ...
    {
        return view('livewire.frontend.cop-single-page')->layout('layouts.web', ['title' => $this->blog->title, 'metaDescription' => $this->metaDescription]);
    }
